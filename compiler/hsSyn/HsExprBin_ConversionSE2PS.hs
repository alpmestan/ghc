...
-- Conversion from GhcSe ASTs to GhcPs ASTs
...
cvRoleAnnotDecl
  :: RoleAnnotDecl GhcSe -> Conv (RoleAnnotDecl GhcPs)
...
cvFamInstEqn
  :: ( XCFamEqn GhcSe (HsTyPats GhcSe) a
     ...
     , XHsIB GhcSe (FamEqn GhcSe (HsTyPats GhcSe) a)
...
cvLHsExpr
  :: LHsExpr GhcSe -> Conv (LHsExpr GhcPs)
cvLHsExpr = traverse cvHsExpr

cvHsExpr
  :: HsExpr GhcSe -> Conv (HsExpr GhcPs)
...
cvLit (HsInteger a b c) = HsInteger a b <$> ifaceTypeToType c
cvLit (HsRat a b c) = HsRat a b <$> ifaceTypeToType c
...
cvMatchGroup
  :: ( XMG GhcSe a ~ XMG GhcPs b
     , XCMatch GhcSe a ~ XCMatch GhcPs b, XCGRHSs GhcSe a ~ XCGRHSs GhcPs b
     , XCGRHS GhcSe a ~ XCGRHS GhcPs b, XXMatchGroup GhcSe a ~ XXMatchGroup GhcPs b
     , XXMatch GhcSe a ~ XXMatch GhcPs b, XXGRHSs GhcSe a ~ XXGRHSs GhcPs b
...
cvMatch
  :: ( XCMatch GhcSe a ~ XCMatch GhcPs b
     , XCGRHSs GhcSe a ~ XCGRHSs GhcPs b, XCGRHS GhcSe a ~ XCGRHS GhcPs b
     , XXMatch GhcSe a ~ XXMatch GhcPs b, XXGRHSs GhcSe a ~ XXGRHSs GhcPs b
     , XXGRHS GhcSe a ~ XXGRHS GhcPs b
     )
...
cvIPBind
  :: IPBind GhcSe -> Conv (IPBind GhcPs)
