...
instance (Binary a, Binary b) => Binary (HsArg a b) where
  put_ bh arg = case arg of
    ...
    HsTypeArg a b -> putByte bh 1 >> put_ bh a >> put_ bh b
...
instance Binary (HsType GhcSe) where
  ...
  get bh = do
    tag <- getByte bh
    case tag of
      0 -> HsForAllTy <$> get bh <*> get bh <*> get bh <*> get bh
      ...
      21 -> HsAppKindTy <$> get bh <*> get bh <*> get bh
      _  -> getPanic "HsType"
...
instance Binary (HsSplice GhcSe) where
  put_ bh s = case s of
    ...
    HsSplicedT {} -> putPanic "HsSplice" "HsSplicedT"
...
instance Binary ForallVisFlag where
  put_ bh f = case f of
    ForallVis   -> putByte bh 0
    ForallInvis -> putByte bh 1
  get bh = do
    tag <- getByte bh
    case tag of
      0 -> pure ForallVis
      1 -> pure ForallInvis
      _ -> getPanic "ForallVisFlag"
